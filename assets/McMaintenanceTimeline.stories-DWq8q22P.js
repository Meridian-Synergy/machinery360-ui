import{e as A,j as s,q as l,F as c,k as _,g as H,o,l as L,t as a,p as d}from"./iframe-CqlfC1nB.js";import{_ as y}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./preload-helper-PPVm8Dsz.js";const w={class:"mc-timeline"},v={class:"mc-timeline__track"},M={class:"mc-timeline__hours"},q={class:"mc-timeline__label"},b=A({__name:"McMaintenanceTimeline",props:{hours:{},milestones:{default:()=>[]},nowLabel:{default:"Now"},hoursUnit:{default:"h"},taskLabel:{},originLabel:{default:void 0}},setup(n){const u=n,f=H(()=>{const r=[...u.milestones].sort((t,g)=>t.dueAtHours-g.dueAtHours),i=r.findIndex(t=>t.dueAtHours>u.hours),e=i===-1?r.length:i;return[...u.originLabel&&u.hours>0?[{kind:"origin",dueAtHours:0,bucket:"past",count:0}]:[],...r.filter(t=>t.dueAtHours>0).slice(0,e).map(t=>({kind:"milestone",...t})),{kind:"now",dueAtHours:u.hours,bucket:"due",count:0},...r.slice(e).map(t=>({kind:"milestone",...t}))]});return(r,i)=>(o(),s("div",w,[l("ol",v,[(o(!0),s(c,null,_(f.value,(e,k)=>(o(),s("li",{key:`${e.kind}-${e.dueAtHours}-${k}`,class:L(["mc-timeline__item",[`mc-timeline__item--${e.kind==="now"?"now":e.bucket}`,{"mc-timeline__item--now":e.kind==="now","mc-timeline__item--origin":e.kind==="origin"}]])},[i[0]||(i[0]=l("span",{class:"mc-timeline__dot","aria-hidden":"true"},null,-1)),l("span",M,a(e.dueAtHours)+" "+a(n.hoursUnit),1),l("span",q,[e.kind==="now"?(o(),s(c,{key:0},[d(a(n.nowLabel),1)],64)):e.kind==="origin"?(o(),s(c,{key:1},[d(a(n.originLabel),1)],64)):n.taskLabel?(o(),s(c,{key:2},[d(a(n.taskLabel(e.count)),1)],64)):(o(),s(c,{key:3},[d(a(e.count),1)],64))])],2))),128))])]))}}),x=y(b,[["__scopeId","data-v-3abc2a37"]]);b.__docgenInfo=Object.assign({displayName:b.name??b.__name},{exportName:"default",displayName:"McMaintenanceTimeline",description:"",tags:{},props:[{name:"hours",description:"Compteur courant, en heures.",required:!0,type:{name:"number"}},{name:"milestones",description:"Échéances : chacune porte le palier auquel elle tombe.",required:!1,type:{name:"Array",elements:[{name:"{ dueAtHours: number, bucket: 'past' | 'overdue' | 'due' | 'soon', count: number }"}]},defaultValue:{func:!1,value:"() => []"}},{name:"nowLabel",description:"Libellés localisés (le DS est i18n-agnostique).",required:!1,type:{name:"string"},defaultValue:{func:!1,value:"'Now'"}},{name:"hoursUnit",required:!1,type:{name:"string"},defaultValue:{func:!1,value:"'h'"}},{name:"taskLabel",required:!1,type:{name:"TSFunctionType"}},{name:"originLabel",description:`Libellé du point d'ORIGINE (0 h). Absent = pas d'origine affichée.
