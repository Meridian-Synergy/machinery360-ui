...
}`,...r.parameters?.docs?.source},description:{story:"Sans `:locales`, un composant contrôlé doit rendre un état vide, pas crasher.",...r.parameters?.docs?.description}}};const R=["Playground","SansLocales"];export{i as Playground,r as SansLocales,R as __namedExportsOrder,A as default};
